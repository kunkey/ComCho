...
?>
         <div class="list1"><?php echo (time() > $gres['lastdate'] + 300 ? '<i class="fa fa-circle" style="color: #868686;"></i> ' : '<i class="fa fa-circle" style="color:#5bc55a"></i> '); ?>
<?php
        if ($gres['vip']) 
...
<?php echo $post, '<br/>'; ?>
<?php echo '<span class="badge pull-right" style="font-size:10px;color:green;"><b>'.functions::display_date($gres['time']).' <i class="fa fa-history"></i></b></span><br><div class="sub" style="margin-top:-8px;"></div></div>'; ?>
