...
if ($rights == 3 || $rights >= 6) {
    ...
    if (isset($_POST['submit'])) {
        ...
        echo '<div class="phdr">' . $lng_forum['voting'] . '</div>';
        echo '<div class="list1"><form style="margin-top:-15px" action="index.php?act=addvote&amp;id=' . $id . '" method="post">' .
        ...
        echo '<p><input type="submit" name="submit" value="' . $lng['save'] . '"/></p></form></div>';
        echo '<div class="rmenu"><a href="index.php?id=' . $id . '">' . $lng['back'] . '</a></div>';
    }
} else {
