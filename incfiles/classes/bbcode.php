...
class bbcode extends core
{
    ...
    */
    private static function highlight_bb($var)
    {
        ...
        // Список замены
        $replace = array(
            '<a href="$1" rel="nofollow"><img src="$1" border="0" style="max-width: 400px;" alt="IMG"/></a>',  
            // Replace image
    ...
    */
    public static function auto_bb($form, $field)
    {
        ...
        $out = '<style>
            ...
            <a href="javascript:tag(\'[img]\', \'[/img]\')"><img style="border: 0;" src="' . self::$system_set['homeurl'] . '/images/bb/img.gif" alt="IMG" title="IMG" /></a>
